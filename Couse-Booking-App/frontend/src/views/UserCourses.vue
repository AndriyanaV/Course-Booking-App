<template>
	<section class="w-full py-[40px] flex justify-center lg:px-[40px] px-[20px] ">
		<div
			class="container max-w-[1320px] mx-auto flex  flex-col text-center  h-auto mt-[100px] justify-center  rounded-[10px] gap-[20px] flex-wrap">
			<Heading heading="My Courses" color="#46A5BA" class="w-full font-bold" fontSize="64" />
				<div class="w-full flex lg:flex-row flex-col gap-[40px] flex-wrap">
